...
| 分类 | 目录 | 工具数 | 说明 |
|------|------|--------|------|
| 云服务商 | [cloud/](cloud/) | 16+ | AWS/GCP/Azure/阿里云/腾讯云/华为云等 |
| 开发者平台 | [dev-platform/](dev-platform/) | 12 | Vercel/Netlify/Heroku/Supabase 等 |
| AI 编程代理 | [ai-agent/](ai-agent/) | 14 | Claude Code/Codex/Gemini CLI/Aider 等 |
| AI 模型平台 | [ai-platform/](ai-platform/) | 10 | Hugging Face/Replicate/Ollama 等 |
...
| 数据库 | [database/](database/) | 25+ | PostgreSQL/MySQL/MongoDB/Redis 等 |
